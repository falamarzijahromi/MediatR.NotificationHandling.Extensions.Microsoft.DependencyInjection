    ...
    public static class Runner
    {
        public static async Task Run(IMediator mediator, WrappingWriter writer, string projectName)
        {
            ...
            var results = new RunResults
            {
                ...
                NotificationHandler = contents.Contains("Got pinged1 async"),
                MultipleNotificationHandlers = contents.Contains("Got pinged1 async") && contents.Contains("Got pinged2 async") && contents.Contains("Got pinged also async"),
